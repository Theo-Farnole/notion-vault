    ...
    return <div>
        ...
        <Content className={style.content}>
            ...
            <section>
                ...
                <p className={style.detailed}>
                    With Notion Vault, you can schedule your backups to run automatically, taking the worry out of remembering to do it manually. Just set it and forget it.
                </p>
            ...
            <section>
                ...
                <p className={style.detailed}>
                    We believe that software is built by people, not just by code. That's why we encourage everyone to be a part of Notion Vault's development. Together, we can build something great.
                </p>


                <a className={style.githubBtn} href="https://github.com/Theo-Farnole/notion-vault" target="_blank" rel="noopener noreferrer">
